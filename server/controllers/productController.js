...
exports.createProduct = async (req, res) => {
  ...
  const { productName, description, detailedDescription, price, hasOffer, originalPrice, discountedPrice, currency, stock, lowStockThreshold, category, optionsEnabled, optionGroups } = req.body;
