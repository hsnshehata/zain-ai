...
// لوج بسيط عشان نتأكد إن الملف بيتحمّل
console.log("messages.js loaded at", new Date().toISOString());
...
window.loadMessagesPage = async function() {
  console.log("loadMessagesPage function called");
...
// Make loadMessagesPage globally accessible (already defined above)
