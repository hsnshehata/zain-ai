...
function showEditBotModal(botId, currentName, currentFacebookApiKey, currentFacebookPageId, ownerUserId, isActive, autoStopDate, subscriptionType, welcomeMessage, currentInstagramApiKey, currentInstagramPageId) {
  const modal = document.createElement("div");
  modal.classList.add("modal");
  modal.innerHTML = `
    <div class="modal-content">
      ...
      <form id="editBotForm">
        ...
        <div class="form-group">
          ...
          <input type="text" id="editFacebookApiKey" value="${currentFacebookApiKey || ''}">
        </div>
        <div class="form-group" id="editFacebookPageIdContainer" style="display: ${currentFacebookApiKey ? 'block' : 'none'}">
          <label for="editFacebookPageId">معرف صفحة فيسبوك (مطلوب إذا تم إدخال API)</label>
          <input type="text" id="editFacebookPageId" value="${currentFacebookPageId || ''}">
        </div>
        <div class="form-group">
