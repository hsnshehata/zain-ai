      ...
      if (selectedBotId) {
        try {
          ...
          if (response.ok) {
            ...
            // Display existing chat page settings with improved layout
            content.innerHTML = `
              <h2>تخصيص صفحة الدردشة</h2>
              <div class="chat-page-settings">
                ...
                <p style="font-size: 0.8em; text-align: center; margin-top: 1rem;">جميع الحقوق محفوظة © ghazal bost</p>
              </div>
            `;
